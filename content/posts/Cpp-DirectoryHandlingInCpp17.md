...
- [目錄](#目錄)
  - [前言](#前言)
  - [C++17 filesystem 簡介](#c17-filesystem-簡介)
    - [基本設定](#基本設定)
    - [編譯設定](#編譯設定)
  - [目錄的基本操作](#目錄的基本操作)
    - [取得當前目錄](#取得當前目錄)
  ...
  - [目錄資訊查詢](#目錄資訊查詢)
    ...
    - [統計目錄內容](#統計目錄內容)
  - [實用範例](#實用範例)
    - [範例 1：目錄備份工具](#範例-1目錄備份工具)
    - [範例 2：清理臨時檔案](#範例-2清理臨時檔案)
    - [範例 3：目錄同步工具](#範例-3目錄同步工具)
    - [範例 4：尋找重複檔案](#範例-4尋找重複檔案)
  - [跨平台考量](#跨平台考量)
    - [路徑分隔符](#路徑分隔符)
    - [處理權限問題](#處理權限問題)
  - [最佳實踐](#最佳實踐)
