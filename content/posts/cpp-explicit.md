...
- [目錄](#目錄)
  - [前言](#前言)
  - [什麼是 explicit](#什麼是-explicit)
    - [C++98/03：單參數建構子](#c9803單參數建構子)
    - [C++11：轉換運算子](#c11轉換運算子)
    - [C++20：條件式 explicit](#c20條件式-explicit)
  - [不用它的缺點](#不用它的缺點)
    - [範例 1：意外的型別轉換](#範例-1意外的型別轉換)
    - [範例 2：bool 轉換的陷阱](#範例-2bool-轉換的陷阱)
  - [有用它的優點](#有用它的優點)
    - [範例 1：避免意外轉換](#範例-1避免意外轉換)
    - [範例 2：安全的 bool 轉換](#範例-2安全的-bool-轉換)
    - [範例 3：標準函式庫的最佳實踐](#範例-3標準函式庫的最佳實踐)
  - [小結](#小結)
    - [使用時機](#使用時機)
    - [核心原則](#核心原則)
    - [經驗法則](#經驗法則)
